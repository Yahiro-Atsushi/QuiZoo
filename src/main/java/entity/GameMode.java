...
public enum GameMode implements Serializable {
	EASY("チンパンジー", " quiz_easy_view ", " journal_easy ", 4), 
	NORMAL("人間", " quiz_normal_view ", " journal_normal ", 4), 
	HARD("オランウータン", " quiz_hard_view ", " journal_hard ", 4),
	CHALLENGE("キメラ", " quiz_challenge ", " journal_challenge ", 4),
	TUTORIAL("テスト", " quiz_test_view ", " journal_test ", 4), ;
